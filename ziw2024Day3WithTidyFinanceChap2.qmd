---
title: "ZIW 2024 Day 3 - TidyFinanceChap2"
...
::: callout-note
Below you are reading modifications to Chapter 2 of **Tidy Finance with R**.
:::
...
head(factors_ff3_monthly)
tail(factors_ff3_monthly)
```
...
head(factors_ff5_monthly)
tail(factors_ff5_monthly)
```
...
head(factors_q_monthly)
tail(factors_q_monthly)
```
...
head(macro_predictors)
tail(macro_predictors)
```
...
Three general packages used in Day 2's coding exercises are "tidyverse, and tidyquant." Some of the functions on which this summary will focus are tidyquant's "tq_get," "tq_mutate,"
